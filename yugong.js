        ...
        <aside id="sidebar" class="sidebar fixed left-0 top-0 h-full w-64 bg-white shadow-lg z-50 overflow-y-auto mobile-sidebar lg:transform-none transition-all duration-300">
          <div class="p-6">
            <div class="flex items-center justify-between mb-8">
              <h2 class="text-2xl font-bold text-primary-500">寓公网</h2>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
              ...
              <a href="javascript:void(0);" target="_blank" class="mt-4 flex items-center px-4 py-2 text-gray-600 hover:text-primary-500 transition duration-300" onclick="copyEmail()">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
                如有具体需求,请发送邮件到luxlsd@163.com与我们沟通。
              </a>
<script>
function copyEmail() {
    const email = 'luxlsd@163.com';
        ...
        <main class="main-content lg:ml-64 min-h-screen transition-all duration-300">
            ...
            <div class="max-w-5xl mx-auto">
              <div class="flex flex-col md:flex-row items-center justify-center">
                <div class="text-center">
                  <h1 class="text-3xl md:text-4xl font-bold mb-2">寓公网</h1>
                  <p class="text-primary-100 max-w-xl">您的AI好助手</p>
                </div>
              </div>
            </div>
          </header>
          ...
          <section class="max-w-7xl mx-auto px-4 sm:px-6 py-8">
            ...
            <div class="flex items-center justify-between mb-6">
              <h2 class="text-xl font-semibold text-gray-800">
                ${catalog ? `${currentCatalog} · ${currentSites.length} 个应用` : `全部收藏 · ${sites.length} 个网站`}
              </h2>
              <div class="text-sm text-gray-500 hidden md:block">
                点击卡片访问应用网站，鼠标悬停可复制链接
              </div>
            </div>
          ...
          <footer class="bg-white py-8 px-6 mt-12 border-t border-gray-200">
            <div class="max-w-5xl mx-auto text-center">
              <p class="text-gray-500">© ${new Date().getFullYear()} 寓公网 | 您的AI好助手</p>
